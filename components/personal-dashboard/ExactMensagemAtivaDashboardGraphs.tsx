...
export function ResgateLeadsCard({ history, loading = false }: { history: HistoryItem[]; loading?: boolean }) {
    ...
    return (
        <VolumeResultsCard
            ...
            infoText="Mostra, por dia, os envios automáticos do Fluxo de Resgate de Leads e quantos geraram respostas e agendamentos."
    ...
    return (
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                {showTemplateFilter && templateData.length > 0 ? (
