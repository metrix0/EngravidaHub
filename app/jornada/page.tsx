...
import {
    FullJourneyPipelineCard as SharedFullJourneyPipelineCard,
    WhatsappCoverageCard as SharedWhatsappCoverageCard,
    TrackedWhatsappSourcesCard as SharedTrackedWhatsappSourcesCard,
} from "@/components/personal-dashboard/ExactJornadaDashboardGraphs";
import {
    JourneyFunnelCard as SharedJourneyFunnelCard,
    EvaluationJourneyFunnelCard as SharedEvaluationJourneyFunnelCard,
    DropoffCard as SharedJourneyDropoffCard,
    IntentPathsCard as SharedIntentPathsCard,
    ObjectionsCard as SharedJourneyObjectionsCard,
} from "@/components/personal-dashboard/ExactJornadaSimpleDashboardGraphs";
...
function FullJourneyPipelineCard({
    ...
    return (
        <SharedFullJourneyPipelineCard
            data={data}
            onSelectRecommendedMonth={onSelectRecommendedMonth}
        />
    );
}
...
function WhatsappCoverageCard({ pipeline }: { pipeline: FullJourneyPipeline }) {
    return <SharedWhatsappCoverageCard pipeline={pipeline} />;
}
...
function TrackedWhatsappSourcesCard({ pipeline }: { pipeline: FullJourneyPipeline }) {
    return <SharedTrackedWhatsappSourcesCard pipeline={pipeline} />;
}
